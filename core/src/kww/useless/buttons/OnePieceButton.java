...
//    private Animation anim;
     ...
     * @param img the image
     */
    public OnePieceButton(Image img)
    {
        this(img, 0, 0);
    }
     ...
     */
    public OnePieceButton(Image img, float x, float y)
    {
        this.img = img;
        this.x = x;
        this.y = y;
...
//        }
        ...
        // text
        if (text != null)
            UselessUtils.Text.drawCentered(font, x, y, text, color);
    }
...
//            image = anim.getCurrentFrame();
        ...
        return ((cx > x - xRad && cx < x + xRad) &&
                (cy > y - yRad && cy < y + yRad) &&
                this.img.getAlphaAt((int) (cx - (x - xRad)), (int) (cy - (y - yRad))) > alpha);
    }
     ...
     */
    public OnePieceButton setHoverAnimationDuration(int duration)
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverAnimationEquation(AnimationEquation eqn)
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverExpand()
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverExpand(float scale)
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverExpand(Expand dir)
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverExpand(float scale, Expand dir)
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverFade()
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverFade(float baseAlpha)
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverRotation()
    {
     ...
     * @return this object for method chaining
     */
    public OnePieceButton setHoverRotation(float maxAngle)
    {
