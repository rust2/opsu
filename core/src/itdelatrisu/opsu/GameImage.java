...
public enum GameImage {
    ...
    PAUSE_OVERLAY("pause-overlay", "png|jpg")
            {
                ...
                protected Image process_sub(Image img, int w, int h)
                {
                    return img.setAlpha(0.7f).getScaledCopy(w, h);
                }
            },
    ...
    SEARCH_BG("search-background", "png|jpg", false, true)
            {
                ...
                protected Image process_sub(Image img, int w, int h)
                {
                    return img.setAlpha(0.8f).getScaledCopy(w, h);
                }
            },
    ...
    /* kww */
    KWW_MUSIC_PLAY("player/play_arrow", "png", false, false)
            {
                @Override
                protected Image process_sub(Image img, int w, int h)
                {
    ...
    KWW_MUSIC_PAUSE("player/pause_circle", "png", false, false)
            {
                @Override
                protected Image process_sub(Image img, int w, int h)
                {
    ...
    KWW_MUSIC_NEXT("player/skip_next", "png", false, false)
            {
                @Override
                protected Image process_sub(Image img, int w, int h)
                {
    ...
    KWW_MUSIC_PREVIOUS("player/skip_previous", "png", false, false)
            {
                @Override
                protected Image process_sub(Image img, int w, int h)
                {
    ...
    /* Toolbar icons */
    TOOLBAR_PROFILE("icons/hexacons/profile", "png", false, true)
            {
                @Override
                protected void process()
                {
                ...
                protected Image process_sub(Image img, int w, int h)
                {
                    float f = Toolbar.baseIconSize * Options.getMobileUIScale(0.5f);
                    return img.getScaledCopy(f, f);
                }
            },
    TOOLBAR_PLAYER("icons/hexacons/music", "png", false, true)
            {
                @Override
                protected void process()
                {
    ...
    TOOLBAR_DOWNLOADS("icons/hexacons/beatmap", "png", false, true)
            {
                @Override
                protected void process()
                {
    ...
    TOOLBAR_SETTINGS("icons/hexacons/settings", "png", false, true)
            {
                @Override
                protected void process()
                {
    ...
    TOOLBAR_ABOUT("icons/hexacons/github", "png", false, true)
            {
                @Override
                protected void process()
                {
    ...
    /* Anything else? */
    PLAYER_DEFAULT_BG("backgrounds/bg4", "png|jpg", false, true);
    /* kww END */
    ...
    {
        return (skinImage != null && !skinImage.isDestroyed());
    }
