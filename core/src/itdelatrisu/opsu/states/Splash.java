...
public class Splash extends BasicGameState {
            ...
            throws SlickException
    {
        ...
        GameImage.MENU_LOGO.getImage().drawCentered(container.getWidth() / 2f, container.getHeight() / 2f);
