...
//	              "Nightcore", "uguuuuuuuu"),
	...
	/**
	 * Bit value associated with the mod. <br>
	 * See the osu! API: <a href="https://github.com/peppy/osu-api/wiki#mods">https://github.com/peppy/osu-api/wiki#mods</a>
	 */
	...
	public static void init(int width, int height) {
		...
		float offsetX = Math.min(GameImage.MOD_EASY.getImage().getWidth() * 2.1f, (width-baseX)/5f);
