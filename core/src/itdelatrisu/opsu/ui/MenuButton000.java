...
public class MenuButton000 {
	 ...
	 */
	public MenuButton000(Image img, float x, float y) {
		this.img = img;
		this.x = x;
		this.y = y;
	 ...
	 * @param y the center y coordinate
	 */
	public MenuButton000(Image imgCenter, Image imgLeft, Image imgRight, float x, float y) {
		this.img  = imgCenter;
		this.imgL = imgLeft;
		this.imgR = imgRight;
		this.x  = x;
	 ...
	 * @param y the center y coordinate
	 */
	public MenuButton000(Animation anim, float x, float y) {
		this.anim = anim;
		this.x = x;
		this.y = y;
