...
public class Cursor {
    ...
    public void hide()
    {
        ...
        System.out.println("Cursor is now hidden"); // FIXME: 21.02.2023 make proper logging solution
    }
    ...
    public void show()
    {
        ...
        System.out.println("Cursor is now displaying"); // FIXME: 21.02.2023 make proper logging solution
    }
}
