...
public class UI {
    ...
    public static void init(GameContainer container, StateBasedGame game)
    {
        ...
        //kww
        Instances.fpsMeter = new FPSMeter();
    }
    ...
    public static void drawFPS()
    {
        ...
        font.drawString(
                container.getWidth() * 0.997f - font.getWidth(s),
                container.getHeight() * 0.997f - font.getHeight(s),
                s, Color.white
        );
    }
    ...
    public static boolean globalKeyPressed(int key)
    {
        switch (key)
        {
            ...
            case Input.KEY_Q:
            {
                if (input.isKeyDown(Input.KEY_LCONTROL) && input.isKeyDown(Input.KEY_LALT) && input.isKeyDown(Input.KEY_LSHIFT))
                {
                    // ctrl + alt + shift + q
                    UselessUtils.Game.restart(container);
                }
                break;
            }
