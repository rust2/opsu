...
public class BaseButton {
	 ...
	 */
	public BaseButton(Image img, float x, float y) {
		this.img = img;
		this.x = x;
		this.y = y;
	 ...
	 * @param y the center y coordinate
	 */
	public BaseButton(Image imgCenter, Image imgLeft, Image imgRight, float x, float y) {
		this.img  = imgCenter;
		this.imgL = imgLeft;
		this.imgR = imgRight;
		this.x  = x;
	 ...
	 * @param y the center y coordinate
	 */
	public BaseButton(Animation anim, float x, float y) {
		this.anim = anim;
		this.x = x;
		this.y = y;
