...
public class OptionsOverlay extends AbstractComponent {
	...
	public OptionsOverlay(GameContainer container, OptionGroup[] groups, OptionsOverlayListener listener) {
		...
		navTargetWidth = (int) (targetWidth * 0.35f) - navButtonSize; // 0.28f
	...
	private void renderNavigation(Graphics g) {
		navWidth = navButtonSize = (int) Instances.toolbar.toolbarSettingsButton.getSize().x;
//		navWidth = (int) Instances.toolbar.toolbarSettingsButton.getSize().x;
