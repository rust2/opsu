...
public class Utils {
	...
	public static void init(GameContainer container, StateBasedGame game) {
		...
		container.setShowFPS(false); // stub
		container.getInput().enableKeyRepeat(); // stub
		container.setAlwaysRender(true); // stub
		container.setUpdateOnlyWhenVisible(false); // stub
